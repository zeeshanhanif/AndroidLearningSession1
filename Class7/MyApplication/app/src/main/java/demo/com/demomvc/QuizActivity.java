...
public class QuizActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cheatButton = (Button)findViewById(R.id.cheatBtn);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode ==0 && resultCode==RESULT_OK) {
            Toast.makeText(this,"Back from Cheat Activity",Toast.LENGTH_SHORT).show();
            if(data !=null){
                boolean isCheater = data.getBooleanExtra(CheatActivity.EXTRA_ANSWER_SHOWN,false);
                Toast.makeText(this,"Cheater = "+isCheater,Toast.LENGTH_SHORT).show();
            }
